...
enum PageType {
    ...
    case postViewController(userPost: UserPost, viewControllerTitle: String)
    case listViewController(viewControllerTitle: String, userRelationships: [UserRelationship])
}
